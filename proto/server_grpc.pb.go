...
type EdgeClient interface {
	Ping(ctx context.Context, in *VersionRequest, opts ...grpc.CallOption) (*VersionReply, error)
}
...
func (c *edgeClient) Ping(ctx context.Context, in *VersionRequest, opts ...grpc.CallOption) (*VersionReply, error) {
	out := new(VersionReply)
	err := c.cc.Invoke(ctx, "/edged.Edge/Ping", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type EdgeServer interface {
	Ping(context.Context, *VersionRequest) (*VersionReply, error)
...
func (UnimplementedEdgeServer) Ping(context.Context, *VersionRequest) (*VersionReply, error) {
...
func _Edge_Ping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/edged.Edge/Ping",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EdgeServer).Ping(ctx, req.(*VersionRequest))
	}
